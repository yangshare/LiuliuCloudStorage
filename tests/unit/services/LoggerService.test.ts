...
describe('LoggerService', () => {
  describe('服务基础功能', () => {
    it('应该能够导入 LoggerService', async () => {
      const { loggerService } = await import('../../../src/main/core/logger/logger.service')
  ...
  describe('单例模式', () => {
    it('应该返回相同的实例', async () => {
      const module1 = await import('../../../src/main/core/logger/logger.service')
      const module2 = await import('../../../src/main/core/logger/logger.service')
  ...
  describe('日志级别枚举', () => {
    it('应该导出 LogLevel 枚举', async () => {
      const { LogLevel } = await import('../../../src/main/core/logger/logger.service')
